...
void set_java_vars(JNIEnv *env, jobject jobj, int fd) {
    ...
    switch (ttyset.c_cflag & CSIZE) {
        case CS5: databits = JDATABITS_5;
            break;
        case CS6: databits = JDATABITS_6;
            break;
        case CS7: databits = JDATABITS_7;
            break;
        case CS8: databits = JDATABITS_8;
            break;
    }
#ifdef CMSPAR
...
#endif /* CMSPAR */
        case 0: jparity = JPARITY_NONE;
            break;
        case PARENB: jparity = JPARITY_EVEN;
            break;
        case PARENB | PARODD: jparity = JPARITY_ODD;
            break;
#ifdef CMSPAR
        case PARENB | PARODD | CMSPAR: jparity = JPARITY_MARK;
            break;
        case PARENB | CMSPAR: jparity = JPARITY_SPACE;
            break;
#endif /* CMSPAR */
    }
    switch (ttyset.c_cflag & (CSTOPB)) {
        case 0: stop_bits = STOPBITS_1;
            break;
        case CSTOPB:
